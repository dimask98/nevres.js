setTimeout (function (){   $("<div class='fr borderg' style='padding:2px;background-color:white;margin-right:4px;'>استايلات : <a href='https://api.whatsapp.com/send?phone=905382743878&text=مرحبا-نورس-السوري&source=&data=&app_absent='> نورس السوري</a></div>").insertAfter($(".loginstat"));  },1000);
	$('.nav-tabs').addClass('fl').css('width','100%');
	$('.light.break').css('color','#595B61')
	$('.nav-tabs>li>a').css({"background-image":"url(sico/1620513034769.jpg)"});
	$('.s1.fa.fa-user.label.badgex.label-as-badge.label-success').css('color','#EDEDED')
	$('.loginstat').css('color','#A9ADB8')
	$('.uzr.fl.corner.borderg.mm ').css('sold','#8A8D96')
	$('.s1.fa.fa-user.label.badgex.label-as-badge.label-success ').css('background-color','#A9ADB8')
	...
	.sultan111,div#d2{background-repeat: no-repeat;background-size: contain;background-image: url();background-color:#7D7D7D}a.label.label-primary.fl{height:35px;border-radius:19px 19px 0 0!important;padding:8px!important;border:2px solid #595B61}
	}
	.fitimg.fl.u-pic {box-shadow: inset 0 1px 1px rgba(0,0,0,.075), 0 0 8px rgb(80, 79, 81);border-radius: 75px 0px 75px 75px;}
	ul.nav.nav-tabs.fl li a {color: #7F9BB3; box-#: inset 0 2px 2px rgb(80, 79, 81), 0 0 8px #(80, 79, 81);font-family: '',;font-size: 13px!important;padding: 6px!important;text-align: center!important;width: 100%;}
	ul.nav.nav-tabs.fl li {border-bottom: 3px rgb(80, 79, 81);width: 33.3%;}
	...
	$('.nav-tabs>li>a').css('color','#69544C')
	$(`<link rel="stylesheet" type="text/css" href="//www.fontstatic.com/f=jazeera-light,jazeera">
	<link rel="stylesheet" href="https://cdn.statically.io/gh/dimask98/nevres.js/main/Zikra.css">
	</style>`).insertBefore('body');
	$('.u-msg.break.fl').css('color','#000000')
	
	$(`<center><div width="99.5%" style="background-image:url(sico/z1d2n7i5vl10.jpeg);color: #595B61;border-radius: 5px 5px 5px5px;border-bottom: 2px solid #ffffff;border-top: 2px solid#ffffff;padding-bottom: 2px!important;"><font style="background-color: #fff;border-radius: 15px 15px 15px 15px;font-family: 'jazeera',FontAwesome;padding: 2px 10px 2px 10px;margin: 7px 10px 7px 10px;">مرحبـاً بكـم جميعاً في شـات ذكره </font></div><center/>`).insertBefore('#d2');
	...
	<div class="collapse" id="collapseExample"><center><div class="well"><p lass="bg-primary"> </p>إدآرة ألمـؤقع / جوكر فلسطين   </p> <i class="fa fa-"></i> <a href="" style="border-radius: 90px 90px 90px 90px;width:48%;margin:2px;" class="fl mini fa fa-star
	btn btn-primary"> تمييز </a>
	...
	$("label.label.tc.border.cp.btn.label-danger.fl").html("<span class='fl fa fa-star'></span> لـوحة تحكم / شآت ذكره") 
