$('.nav-tabs').addClass('fl').css('width','100%');
	...
	$('.nav-tabs>li>a').css({"background-image":"url(sico/z1f59iiggl10.jpeg)"});
	...
	$(`<center><div width="99.5%" style="background-image:url(sico/z1d2n7i5vl10.jpeg);color: #595B61;border-radius: 5px 5px 5px5px;border-bottom: 2px solid #ffffff;border-top: 2px solid#ffffff;padding-bottom: 2px!important;"><font style="background-color: #fff;border-radius: 15px 15px 15px 15px;font-family: 'jazeera',FontAwesome;padding: 2px 10px 2px 10px;margin: 7px 10px 7px 10px;">مرحبـاً بكـم جميعاً في شـات حلم </font></div><center/>`).insertBefore('#d2');
	$(`<a id="des3" href="" style="border-radius: 24px 0px 24px 0px;width:23%;margin:2px;" class="fl mini  fa  fa-
 btn btn-primary">  اتصل بنا</a>
<a id="des3" href="" style="border-radius: 48px 0px 48px 0px;width:24%;margin:2px;" class="fl mini fa  fa-
