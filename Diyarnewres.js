 ...
 $("div#tlogins button.btn.btn-primary").click(function(){var myVar = setInterval(function(){ var usmsgw = $(".pmsgc").length;if(usmsgw > 0){
   $(`
    <div class="uzr fl corner borderg mm" style="border-radius:5px;margin-bottom:-2px;width:99.5%;padding:0px; background-color:white;">
      <img style="width: 36px; height: 38px; margin-left: 1px; margin-top: 1px; background-image: url(https://almhapa.com/sico/z1f3h9v6di10.jpeg);" class="fl fitimg hand u-pic    ">
      <div class="uzr fl" style="padding:0px;width:80%">
        <div style="padding:0px;width:100%;" class="fl">
          <img class="fl u-ico" alt="" src="https://almhapa.com/sico/z1f3h9vd5m10.png"    >
          <span style="padding: 1px 8px; margin-top: 2px; display: block; max-width: 82%; border-radius: 3px; color: rgb(199, 103, 48);" class="corner nosel u-topic dots fl hand">   شات ديار المحبه للجوال</span>
        </div>
        <br>
        <div style="padding: 0px; width: 100%; color: rgb(60, 0, 255);" class=" u-msg   break  fl">
        <div style="padding: 0px;width: 100%;color: rgb(60, 0, 255);text-align: left;display: block;margin-top: -17px;" class=" u-msg   break  fl"> مرحباً بك 👋<h1 style="display: inline-block;color: red;">`+ getuser(myid).topic+ `</h1>    نقدّر تواجدك معنا، ونتمنى لك يوماً سعيداً إن شاء الله في شات ديار المحبه </div>
      </div>
    </div></div>
    `).appendTo('div#d2')
clearInterval(myVar);
...
><font style="background-color: #fff;border-radius: 0px 25px 0px 25px;font-family: 'Cairo', sans-serif, FontAwesome;padding: 2px 10px 2px 10px; margin:0px 25px 0px 25px;" >اهلآ وسهلاً بكم فِي شآت  ديار المحبه للجوال</font></div></div><center>`).insertBefore('#d2');
$(`<img style="height:50px;width: 100%;margin-right: 5px;background-color: #DE9DA5;" src="https://almhapa.com/sico/z1f3hb3n3r10.jpeg" border="0">`).insertBefore('div#d2bc');
...
<marquee direction="right" width="65%" direction="right" style="margin-bottom: -9px;font-family: 'Changa', sans-serif;    height: 20px;color: #;"  onmouseover="this.stop()" onmouseout="this.start()" scrolldelay="0" scrollamount="5"> مُرحب بالجميع في  شات ديار المحبه اكبر تجمع عربي هذه سَماء ذاتُ سَعة و امْتِداد ،و أنتم نجومها. نحن  المميزون والباقي المقلدون  )
</marquee></font></b></td>
...
$("div#l3 button.btn.btn-primary").bind("click",function(){alert("عند تسجيلك للعضوية فانك توافق علا قوانين ديار المحبه واي اختلال في القوانين سيتم حظرك وحذف العضوية");})

$("div#l2 button.btn.btn-primary").bind("click",function(){alert("اهلا ويهلا بكم في عائلتنا عائلة شات ديار المحبه  ");})
